    ...
    <span class="nav-item">
        <?php if (!session('uid')): ?>
            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                    <a class="btn btn-login" href="https://oprimeboost.com"><?=lang("Home")?></a>
                </li>
                                <li class="nav-item">
                    <a class="btn btn-login" href="<?=cn('auth/login')?>"><?=lang("Services")?></a>
                </li>
                                                <li class="nav-item">
                    <a class="btn btn-login" href="https://oprimeboost.com/api/docs"><?=lang("API")?></a>
                </li>
                                <li class="nav-item">
                    <a class="btn btn-login" href="<?=cn('auth/login')?>"><?=lang("Login")?></a>
                <?php if (!get_option('disable_signup_page')): ?>
                    <li class="nav-item">
                        <a class="btn btn-primary btn-getstarted" href="<?=cn('auth/signup')?>"><?=lang("Sign Up")?></a>
                    </li>
                <?php endif; ?>
            </ul>
        <?php else: ?>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6">
                        <div class="text-container">
                            ...
                            <a class="btn btn-primary btn-getstarted" href="https://oprimeboost.com/auth/login" data-aos="fade-up" data-aos-delay="600"><?=lang("get_start_now")?> <i class="fas fa-arrow-right"></i> </a>
                        </div>
                    </div> 
                    <div class="col-lg-6 col-xl-6">
        ...
        <div class="container">
          ...
          <div class="wrapper footer-bottom">
            <div class="copyrights">
              <p><?=get_option('copy_right_content', "Copyright &copy; 2023 - ");?></p>
            </div>
              <div class="copyright">
 <p><a style="color: white;" href="https://wa.me/2348169581573"><b>Designed by Webblisstech</b></a></p>
        </div>
            <div class="footer-menu footer-links">
              <ul>
                ...
                <li><a href="https://oprimeboost.com/api/docs">API</a></li>
