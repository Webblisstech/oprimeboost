                ...
                <div class="col-lg-6">
                    <div class="account-form">
                        <div class="account-form__content mb-4">
                            ...
                            <p class="account-form__desc">@lang('Please Provide your valid informations to register Dont use capital letter on ur username everything should be small letter')!</p>
                        </div>
                        <form action="{{ route('user.register') }}" method="POST" class="verify-gcaptcha">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-sm-6">
                                     <div class="form-group">
                                        <label for="name" class="form--label"> @lang('Username should be small letters')</label>
