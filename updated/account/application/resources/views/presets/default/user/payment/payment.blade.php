...
@section('content')
@php
    $brandPackage = Session::get('brandPackageOrder');
    $serviceOrder = Session::get('serviceOrder');
@endphp
            ...
            <form action="{{route('user.deposit.insert')}}" method="post">
                ...
                <h3 class="contact__title">{{$pageTitle}}</h3>
                       <div class="row gy-md gy-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="input-group country-code">
                                    ...
                                    <input type="number" step="any" name="amount" class="form-control form--control"
                                        value="{{ $brandPackage['price'] }}" autocomplete="off" readonly>
                                        @elseif(@$serviceOrder)
                                        <input type="number" step="any" name="amount" class="form-control form--control"
                                        value="{{ $serviceOrder['price'] }}" autocomplete="off" readonly>
                                        @endif
                                </div>
                            </div>
                       </div>
                        ...
                        <button type="submit" class="btn btn--base w-25 mt-3">@lang('Submit')</button>
            </form>
