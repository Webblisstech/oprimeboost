            ...
            <div class="row">
                <div class="header-wrapper">
                    ...
                    <div class="logo-wrapper">
                        <a href="https://oprimeboost.com" class="normal-logo"> <img src="{{ getImage(getFilePath('logoIcon').'/logo.png', '?'
                            .time()) }}" alt="{{config('app.name')}}"></a>
                        <a href="https://oprimeboost.com" class="dark-logo hidden"> <img src="{{ getImage(getFilePath('logoIcon').'/logo_white.png', '?'
                            .time()) }}" alt="{{config('app.name')}}"></a>
                    </div>
...
<div class="sidebar-menu-wrapper">
    <div class="top-close d-flex align-items-center justify-content-between">
        <div class="header-wrapper">
            <div class="logo-wrapper mb-1">
                <div class="logo-wrapper">
                    <a href="https://oprimeboost.com" class="normal-logo" id="normal-logo"> <img src="{{ getImage(getFilePath('logoIcon').'/logo.png', '?'
                        .time()) }}" alt="{{config('app.name')}}"></a>
                    <a href="https://oprimeboost.com" class="dark-logo hidden" id="dark-logo"> <img src="{{ getImage(getFilePath('logoIcon').'/logo_white.png', '?'
                        .time()) }}" alt="{{config('app.name')}}"></a>
                </div>
            </div>
        </div>
    ...
    <ul class="sidebar-menu-list">
        ...
        <li class="sidebar-menu-list__item {{ Route::is('user.home') ? 'active' : '' }}">
            <a class="sidebar-menu-list__link" href="{{route('user.home')}}"> @lang('Dashboard') </a>
        </li>
        @endauth
        @foreach($pages as $page)
