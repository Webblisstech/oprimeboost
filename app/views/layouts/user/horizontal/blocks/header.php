    ...
    <div class="row align-items-center">
      <div class="col-lg order-lg-first">
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
            <a href="https://oprimeboost.com/api/docs" class="nav-link <?=(segment(1) == $header_elements['new_order']['route-name'])? "active" : "" ?>"><i class="<?=$header_elements['new_order']['icon']; ?>"></i>API</a>
          </li>   
          <li class="nav-item">
